    ...
    <div className=" container banner">
      <div className="row">
        <div className="col-md-6 m-auto">
          <h1 className="text-white fs-1">Sing up and scoot off today</h1>
        </div>
        <div className="col-md-6 m-auto p-1 mb-2">
          <Button className="my-5 mx-5 p-2" variant="outline-dark">
            <span className="text-white">Available on the AppStore </span>
            <div>
              <FontAwesomeIcon className="fs-1 mx-1" icon={faApple} />
            </div>
          </Button>
          <Button className="my-5 mx-5 p-2" variant="outline-dark">
          <span className="text-white">Get it on GooglePlay </span>
            <div>
